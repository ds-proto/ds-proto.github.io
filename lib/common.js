var appstate = {
  ...
  defaultColors: [
    new dimple.color("#e6a9ae","#da7f9c", 0.65), // red
    new dimple.color("#75b6dc","#309eda", 0.65), // blue
    new dimple.color("#f6c4a4","#e9b898", 0.65), // orange
    new dimple.color("#cfdab9","#b7d289", 0.65), // green
    new dimple.color("#d0aee0","#c097d4", 0.65), // purple
    new dimple.color("#f9e9af","#f5e4ae", 0.65), // yellow
    new dimple.color("#b6e3db","#acd9d0", 0.65), // turquoise
    new dimple.color("#b9cad1","#adbec5", 0.65), // gray
    new dimple.color("#f8f8e9","#f5f9e6", 0.65)  // magenta
  ]
